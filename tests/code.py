...
def obter_dados_luminosidade(lastN):
    #url = f"http://46.17.108.113:8666/STH/v1/contextEntities/type/Lamp/id/urn:ngsi-ld:Lamp:00x/attributes/luminosity?lastN={lastN}"
    url = f"http://{{ip}}:1026/v2/entities/urn:ngsi-ld:entity:001"
